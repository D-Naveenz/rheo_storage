...
- Preserve the existing `filedefs.rpkg` runtime package contract while allowing the Rust builder to ingest newer TrID XML sources directly from `.7z` archives.

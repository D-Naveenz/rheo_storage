...
pub struct NativeWatchHandle {
    pub(crate) handle: Mutex<Option<rheo_storage::DirectoryWatchHandle>>,
}
...
impl NativeOperationHandle {
    ...
    pub(crate) fn state(&self) -> RheoOperationState {
    ...
    pub(crate) fn snapshot(&self) -> RheoOperationSnapshot {
...
) -> Arc<dyn rheo_storage::ProgressReporter> {
